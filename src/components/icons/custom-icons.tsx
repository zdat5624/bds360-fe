// File: @/components/icons/custom-icons.tsx
...
// ==========================================
// ICONS CHO SMART FILTER BAR
// ==========================================
export const SearchIcon = ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className} {...props}>
...
export const ArrowLeftIcon = ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className} {...props}>
...
export const MoneyIcon = ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
);

export const AreaIcon = ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...props}>
...
// ICONS HIỆN CÓ
// ==========================================
export const BedIcon = ({ className = "", ...props }: IconProps) => (
...
export const BathIcon = ({ className = "", ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
export const ZaloIcon = ({ className = "", ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="none" className={className} {...props}>
